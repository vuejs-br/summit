...
div
  .container
    ...
    .container__inner
      ...
      attraction(v-for="hotel of hotels", key="index", :attraction="hotel")
      ...
      attraction(v-for="restaurant of restaurants", key="index", :attraction="restaurant")
      h2: strong Good to know
      p.
        A bit more key information to make your stay comfortable!

      hint(v-for="hint of hints", key="index", :hint="hint")
      ...
      attraction(v-for="sight of sights", key="index", :attraction="sight")
</template>
